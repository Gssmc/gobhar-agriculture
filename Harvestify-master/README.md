...
- Clone the complete project with `git clone https://github.com/bharathkannandeveloper/gobhar-agriculture.git` or you can just download the code and unzip it
- 
